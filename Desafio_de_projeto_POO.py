...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if valor> self.limite:
            print("Operação Falhou! O valor informado é maior que o limite por saque.")
        
        elif numero_saques>=self.limite_saques:
            print("Operação Falhou! A quantidade de saques por dia já foi efetuada.")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    limite_saques = float(input("Informe a quantidade limite de saque por dia: "))
